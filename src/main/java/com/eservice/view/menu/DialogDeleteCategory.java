...
public class DialogDeleteCategory {
    public static void create(int position){
        ...
        Label label1 = new Label("Delete Category ?\n With this all the Menu Items will be deleted");
        ...
        dialog.setResultConverter(dialogButton -> {
            if (dialogButton == ButtonType.OK) {
                ...
                try {
                    ...
                    Category.remove(db,position);

                    FXMLLoader loader = new FXMLLoader(DialogDeleteCategory.class.getResource("/com/eservice/controllers/MenuPage.fxml"));
