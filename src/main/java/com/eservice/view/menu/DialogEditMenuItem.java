...
public class DialogEditMenuItem {
    public static void create(String CategoryName,int position,String itemName,String itemCost){
        // Create the custom dialog
        Alert dialog = new Alert(Alert.AlertType.NONE);
        dialog.setTitle("Edit");
        dialog.setHeaderText("Edit Item : "+itemName);
        ...
        TextField textField1 = new TextField(itemName);
        TextField textField2 = new TextField(itemCost);
        ...
        dialog.setResultConverter(dialogButton -> {
            if (dialogButton == ButtonType.OK) {
                ...
                try {
                    ...
                    MenuItem.edit(position,db,CategoryName,value1,value2);
