...
public class DialogEditCategory {
    public static void create(String CategoryName,int position){
        ...
        TextField textField1 = new TextField(CategoryName);
        ...
        dialog.setResultConverter(dialogButton -> {
            if (dialogButton == ButtonType.OK) {
                ...
                try {
                    ...
                    Category.edit(position,db,value1);
